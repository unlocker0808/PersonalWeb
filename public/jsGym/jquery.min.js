...
!(function (e, t) {
  ...
  var d = (function (n) {
    ...
    try {
      H.apply ((t = O.call (p.childNodes)), p.childNodes), t[
        p.childNodes.length
      ].nodeType;
    } catch (e) {
      H = {
    ...
    for (e in ((d = se.support = {}), (i = se.isXML = function (e) {
      ...
      return r != C &&
        ...
        ((a = (C = r).documentElement), (E = !i (C)), p != C &&
          ...
          s.length && new RegExp (s.join ('|'))), (t = K.test (
      ...
      var t, n = [], r = 0, i = 0;
      if (
        ((l = !d.detectDuplicates), (u = !d.sortStable && e.slice (0)), e.sort (
          j
        ), l)
      ) {
        while ((t = e[i++]))
    ...
    return (me.prototype = b.filters =
      b.pseudos), (b.setFilters = new me ()), (h = se.tokenize = function (
      e,
      t
    ) {
  ...
  ((S.fn.init = function (e, t, n) {
    ...
    if (((n = n || D), 'string' == typeof e)) {
      ...
      if (r[1]) {
        if (
          ((t = t instanceof S ? t[0] : t), S.merge (
            this,
  ...
  }), S.each (
    {
      ...
      contents: function (e) {
        return null != e.contentDocument && r (e.contentDocument)
          ? e.contentDocument
          : (A (e, 'template') && (e = e.content || e), S.merge (
              [],
              e.childNodes
            ));
      },
  ...
  (S.Callbacks = function (r) {
    ...
    when: function (e) {
      ...
      if (
        n <= 1 &&
        (I (e, o.done (a (t)).resolve, o.reject, !n), 'pending' ===
  ...
  function Z (e, t, n) {
    ...
    if (void 0 === n && 1 === e.nodeType)
      if (
        ((r = 'data-' + t.replace (K, '-$&').toLowerCase ()), 'string' ==
  ...
  function Ee (e, t, n, r, i, o) {
    ...
    return 1 === o &&
      ((a = i), ((i = function (e) {
        ...
        a.guid || (a.guid = S.guid++))), e.each (function () {
          ...
          handler: function (e) {
            ...
            if (1 & e.isTrigger && this[i]) {
              if (r.length)
                ...
                ((r = s.call (arguments)), Y.set (this, i, r), (t = o (
                  this,
                  i
                )), this[i] (), r !== (n = Y.get (this, i)) || t
                  ? Y.set (this, i, !1)
                  : (n = {}), r !== n)
              )
  ...
  (S.event = {
      ...
      if (V (t)) {
        ...
        while (l--)
          (d = g = (s = be.exec (e[l]) || [])[1]), (h = (s[2] || '')
            .split ('.')
            .sort ()), d &&
            ((f = S.event.special[d] || {}), (d =
              (i ? f.delegateType : f.bindType) || d), (f = S.event.special[
              d
            ] || {}), (c = S.extend (
              {
                type: d,
    ...
    remove: function (e, t, n, r, i) {
      ...
      if (v && (u = v.events)) {
        ...
        while (l--)
          if (
            ((d = g = (s = be.exec (t[l]) || [])[1]), (h = (s[2] || '')
              .split ('.')
              .sort ()), d)
          ) {
            (f = S.event.special[d] || {}), (p = u[
            ...
            a &&
              ...
              ((f.teardown && !1 !== f.teardown.call (e, h, v.handle)) ||
                S.removeEvent (e, d, v.handle), delete u[d]);
  ...
  function He (n, r, i, o) {
    ...
    if (
      f &&
      ((t = (e = xe (r, n[0].ownerDocument, !1, n, o)).firstChild), 1 ===
        e.childNodes.length && (e = t), t || o)
    ) {
      for (s = (a = S.map (ve (e, 'script'), De)).length; c < f; c++)
        (u = e), c !== p &&
          ((u = S.clone (u, !0, !0)), s &&
            S.merge (a, ve (u, 'script'))), i.call (n[c], u, c);
      if (s)
        for (
    ...
    l.style &&
      ((l.style.backgroundClip = 'content-box'), (l.cloneNode (
        ...
        reliableTrDimensions: function () {
          var e, t, n, r;
          return null == a &&
            ((e = E.createElement ('table')), (t = E.createElement (
              'tr'
            )), (n = E.createElement ('div')), (e.style.cssText =
              'position:absolute;left:-11111px;border-collapse:separate'), (t.style.cssText =
              'border:1px solid'), (t.style.height = '1px'), (n.style.height =
              '9px'), (n.style.display = 'block'), re
              .appendChild (e)
              .appendChild (t)
              .appendChild (n), (r = C.getComputedStyle (t)), (a =
  ...
  function Je (e, t, n) {
    ...
    return ((!y.boxSizingReliable () && i) ||
      ...
      ((i = 'border-box' === S.css (e, 'boxSizing', !1, r)), (o = s in e) &&
        (a =
          e[
            s
  ...
  S.extend ({
    ...
    style: function (e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        ...
        if (
          (u || (t = ze (s)), (a = S.cssHooks[t] || S.cssHooks[s]), void 0 ===
            n)
        )
        ...
        'string' === (o = typeof n) &&
          ...
          ('number' !== o ||
            u ||
            (n +=
              (i && i[3]) || (S.cssNumber[s] ? '' : 'px')), y.clearCloneStyle ||
            '' !== n ||
    ...
    css: function (e, t, n, r) {
      var i, o, a, s = X (t);
      return Xe.test (t) || (t = ze (s)), (a =
        S.cssHooks[t] || S.cssHooks[s]) &&
        'get' in a &&
  ...
  function ot () {
    et &&
      (!1 === E.hidden && C.requestAnimationFrame
        ...
        : C.setTimeout (ot, S.fx.interval), S.fx.tick ());
  }
  function at () {
  ...
  function lt (o, e, t) {
    ...
    for (
      !(function (e, t) {
        ...
        for (n in e)
          if (
            ((i = t[(r = X (n))]), (o = e[n]), Array.isArray (o) &&
              ((i = o[1]), (o = e[n] = o[0])), n !== r &&
        ...
        if ((u = !S.isEmptyObject (t)) || !S.isEmptyObject (d))
          for (r in (f &&
            ...
            ((n.overflow = [h.overflow, h.overflowX, h.overflowY]), null ==
              (l = v && v.display) && (l = Y.get (e, 'display')), 'none' ===
              (c = S.css (e, 'display')) &&
              (l
                ? (c = l)
                : (le ([e], !0), (l = e.style.display || l), (c = S.css (
                    e,
                    'display'
                  )), le ([e]))), ('inline' === c ||
            ...
            u ||
              (v
                ...
                for (r in (g ||
                  le ([e]), Y.remove (e, 'fxshow'), d)) S.style (e, r, d[r]);
  ...
  S.fn.extend ({
        ...
        return 'undefined' == typeof e.getAttribute
          ...
          : ((1 === o && S.isXMLDoc (e)) ||
              (i =
                ...
                (S.expr.match.bool.test (t) ? ct : void 0)), void 0 !== n
              ? null === n
    ...
    ft[t] = function (e, t, n) {
      ...
      return n ||
        ((i = ft[o]), (ft[o] = r), (r = null != a (e, t, n) ? o : null), (ft[
          o
        ] = i)), r;
    };
  });
  ...
  S.extend (S.event, {
    trigger: function (e, t, n, r) {
      ...
      if (
        ((o = f = a = n = n || E), 3 !== n.nodeType &&
          8 !== n.nodeType &&
          !mt.test (d + S.event.triggered) &&
          (-1 < d.indexOf ('.') &&
            ((d = (h = d.split ('.')).shift ()), h.sort ()), (u =
            d.indexOf (':') < 0 && 'on' + d), ((e = e[S.expando]
            ? e
            ...
            (e.target = n), (t = null == t ? [e] : S.makeArray (t, [e])), (c = S
            .event.special[d] || {}), r ||
            !c.trigger ||
  ...
  (Mt.href = bt.href), S.extend ({
    ...
    ajax: function (e, t) {
      ...
      if (
        (x.promise (T), (v.url = ((e || v.url || bt.href) + '').replace (
          Ht,
          bt.protocol + '//'
        )), (v.type =
          t.method ||
      ...
      if (
        (v.data &&
          ...
          (v.data = S.param (v.data, v.traditional)), Wt (Ot, v, t, T), h)
      )
        return T;
      for (i in ((g = S.event && v.global) &&
        ...
        S.event.trigger (
          'ajaxStart'
        ), (v.type = v.type.toUpperCase ()), (v.hasContent = !Lt.test (
        v.type
      )), (f = v.url.replace (jt, '')), v.hasContent
        ? v.data &&
            v.processData &&
            0 ===
              (v.contentType || '')
        ...
        : ((o = v.url.slice (f.length)), v.data &&
            ...
            ((f += (Tt.test (f) ? '&' : '?') + v.data), delete v.data), !1 ===
            v.cache &&
            ((f = f.replace (Dt, '$1')), (o =
              (Tt.test (f) ? '&' : '?') + '_=' + wt.guid++ + o)), (v.url =
            f + o)), v.ifModified &&
        (S.lastModified[f] &&
          T.setRequestHeader ('If-Modified-Since', S.lastModified[f]), S.etag[
          f
      ...
      function l (e, t, n, r) {
        var i, o, a, s, u, l = t;
        h ||
          ((h = !0), d && C.clearTimeout (d), (c = void 0), (p =
            ...
            (m.trigger ('ajaxComplete', [T, v]), --S.active ||
    ...
    wrapAll: function (e) {
      var t;
      return this[0] &&
        (m (e) && (e = e.call (this[0])), (t = S (e, this[0].ownerDocument)
          .eq (0)
